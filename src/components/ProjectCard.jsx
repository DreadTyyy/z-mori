import { Box, Text, Flex, Heading, GridItem, Img } from "@chakra-ui/react";
...
const ProjectCard = ({
  ...
  return (
    <GridItem w="100%" cursor="pointer" rounded="8px 8px 0 0">
      <motion.div
        style={{
          perspective: 800,
          width: "100%",
        ...
        <motion.div
              ...
              <Box transform="translate(5%, 16%)" w="100%" h="100%">
                <Link to={`project/${slug}`}>
                  <Img
                    ...
                    _hover={{
                      boxShadow: "0 0 6px 2px rgba(202, 255, 48, 0.6)",
          ...
          <Box px={4} py={2} w="100%" color="whitemori">
            ...
            <Text as="p" py={2} my={1} fontWeight={400} fontStyle="16px">
              {description}
            </Text>
            <Flex
              w="100%"
              ...
              <Flex
                ...
                gap={2}
                fontSize="18px">
                <Text as="p" fontSize="14px" color="black.750" opacity="0.8">
                  build with{" "}
                </Text>
                {technology.map((tech) => (
...
ProjectCard.propTypes = {
  ...
  urlSite: PropTypes.string.isRequired,
